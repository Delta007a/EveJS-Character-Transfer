...
App v0.2.0 keeps the existing portable Windows EXE packaging model. Its updater is deliberately limited to checking the latest stable public release from the pinned `Delta007a/EveJS-Character-Transfer` GitHub repository and opening that repository's fixed latest-release page.
