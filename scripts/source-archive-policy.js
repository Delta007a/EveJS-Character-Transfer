...
const ALLOWED = [
  ...
  /^docs\/[A-Za-z0-9._-]+\.md$/,
  /^release\/README\.txt$/,
  /^engine\/accepted-r1\.6\/(?:EXAMPLE-COMMANDS\.ps1|README\.md|SHA256SUMS\.txt|SOURCE-REVIEW\.md|STATUS\.txt|private-identity-transfer\.js|verify-private-identity-transfer-(?:achievements|blueprints|portraits|static|structure-policy|wallet)\.js)$/,
